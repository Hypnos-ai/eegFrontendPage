...
class AdaptiveDQNRLEEGNET:
    ...
    def setup_eeg(self, path='formatted_data/S03.fif'):
        ...
        mapping = {
            'EEG 1': 'FCz', 'EEG 2': 'C3', 'EEG 3': 'FC1',
            'EEG 4': 'CPz', 'EEG 5': 'C2', 'EEG 6': 'C4'
        }
    ...
    def process_epochs(self, event_ids=[1, 2, 3, 4, 5]):
        ...
        self.X_train, self.X_test, self.y_train, self.y_test = train_test_split(
            ftrs, y_flattened, train_size=0.9, random_state=42, stratify=y_flattened
        )
        ...
        class Plasticity(gym.Env):
            ...
            def _next_obs(self_):
                if self_.random:
                    ...
                    self_.dataset_idx = (self_.dataset_idx) % (len(self_.x))
                return obs
